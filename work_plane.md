# 05.06.2023 г.
[ ] Снятие подсветки при уходе с EditObjectVC на SelectObjectVC
[ ] Возвращать зум при уходе с SelectObjectVC
[ ] опечатки на MainSettingsVC + иконки
[ ] Корректно обрарабывать тапы по полигонам
