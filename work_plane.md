# 01.06.2023 г.
[ ] Использовать временные файлы в загрузке и индексации объектов
[ ] Оптимизировать использование lock.lock()

[X] Подправить стили
    - Реализовано. Изменил границу зума на 17
[ ] Поле для комментария сделать через UITextField, при каждом тапе на выбор объекта обновляьть placeHolder через генерацию комментария
[ ] Название для поля ввода комментария - Comment

[ ] Mark to deletion -> Discard changes
[ ] Версию приложения при открытии ченджесета брать автоматически
------------
Невыполненные ранее:
