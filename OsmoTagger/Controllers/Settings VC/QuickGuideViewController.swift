...
class QuickGuideViewController: ScrollViewController {
    ...
    func setupContentView() {
        ...
        NSLayoutConstraint.activate([
            ...
            image0.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor, constant: 25),
            image0.trailingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.trailingAnchor, constant: -25),
            ...
            label0.leadingAnchor.constraint(equalTo: image0.leadingAnchor),
            label0.trailingAnchor.constraint(equalTo: image0.trailingAnchor),
            
            image1.topAnchor.constraint(equalTo: label0.bottomAnchor, constant: 20),
            image1.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor, constant: 25),
            image1.trailingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.trailingAnchor, constant: -25),
            ...
            label1.leadingAnchor.constraint(equalTo: image1.leadingAnchor),
            label1.trailingAnchor.constraint(equalTo: image1.trailingAnchor),
            
            image3.topAnchor.constraint(equalTo: label1.bottomAnchor, constant: 20),
            image3.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor, constant: 25),
            image3.trailingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.trailingAnchor, constant: -25),
            ...
            label3.leadingAnchor.constraint(equalTo: image3.leadingAnchor),
            label3.trailingAnchor.constraint(equalTo: image3.trailingAnchor),
            
            image4.topAnchor.constraint(equalTo: label3.bottomAnchor, constant: 20),
            image4.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor, constant: 25),
            image4.trailingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.trailingAnchor, constant: -25),
            ...
            label4.leadingAnchor.constraint(equalTo: image4.leadingAnchor),
            label4.trailingAnchor.constraint(equalTo: image4.trailingAnchor),
